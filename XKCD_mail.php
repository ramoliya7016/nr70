<?php
    ...
    $img_path = 'C:\xampp\htdocs\mail\index.png';
                ...
                <html>
                    ...
                    <body>
                        <center>
                            ...
                            <a href='https://dashboard.heroku.com/apps/nrc70/unsubscribe.php?email=$to&hash=$hash'><h3>Unsubscribe XKCD</h3></a>
                        </center><br/>
                    </body>
                </html>
            ";

        $headers = "From: nikunj.ramoliya108010@marwadiuniversity.ac.in";
